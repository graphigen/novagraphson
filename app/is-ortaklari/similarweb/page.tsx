...
export default function SimilarWebPage() {
  ...
  return (
    <div className="min-h-screen bg-purple-900">
      <Head>
        <title>NovaGraph - SimilarWeb Rakip Analizi</title>
        <meta name="description" content="SimilarWeb ile rakiplerinizi analiz edin, pazar fırsatlarını keşfedin ve dijital stratejinizi optimize edin." />
        <meta name="keywords" content="SimilarWeb, rakip analizi, NovaGraph, dijital istihbarat, pazar analizi, web analitik" />
      </Head>
      {/* Hero Section */}
