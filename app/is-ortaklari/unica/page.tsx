...
import { Users, MessageSquare, Calendar, FileText, BarChart3, ShoppingCart, CheckCircle, ArrowRight, Zap, Shield, Database, Monitor, Activity, TrendingUp, Globe, Settings, Target, ArrowLeft, Building } from "lucide-react"
...
export default function UnicaPage() {
  ...
  const features = [
    {
      ...
      description: "Pazarlama otomasyonu çözümleri"
    },
    {
      icon: Target,
      title: "Customer Analytics",
      description: "Müşteri analitik ve içgörüler"
    },
    {
      icon: BarChart3,
      title: "Personalization",
      description: "Kişiselleştirme ve segmentasyon"
    },
    {
      icon: Zap,
      title: "Campaign Management",
      description: "Kampanya yönetimi ve optimizasyon"
    }
  ]
  ...
  const solutions = [
    ...
    {
      title: "Customer Analytics",
      description: "Müşteri davranışlarını analiz edin ve içgörüler elde edin",
      benefits: [
      ...
      novaGraphUsage: "Müşteri veri analizi ve strateji geliştirme"
    },
    {
      title: "Personalization",
      description: "Müşteri deneyimini kişiselleştirin ve dönüşümleri artırın",
      benefits: [
        "Kişiselleştirme",
        "Segmentasyon",
        "A/B testleri",
      ...
      novaGraphUsage: "Müşteri deneyimini kişiselleştirme ve optimizasyon"
    },
    {
      title: "Campaign Management",
      description: "Kampanya yönetimi ve performans optimizasyonu",
      benefits: [
        "Kampanya yönetimi",
        "Performans takibi",
        "Optimizasyon",
      ...
      novaGraphUsage: "Müşteri kampanya yönetimi ve performans optimizasyonu"
    }
  ]
  ...
  const useCases = [
    {
      ...
      description: "E-ticaret sitelerinde kişiselleştirme ve optimizasyon",
      icon: ShoppingCart,
      benefits: [
        "Kişiselleştirme",
        "Kampanya yönetimi",
    ...
    },
    {
      ...
      description: "Kurumsal şirketlerde pazarlama otomasyonu",
      icon: Building,
      benefits: [
    ...
    },
    {
      ...
      description: "Dijital pazarlama kampanyalarının optimizasyonu",
      icon: TrendingUp,
      benefits: [
  ...
  return (
    <div className="min-h-screen bg-blue-900">
      <Head>
        <title>NovaGraph - Unica Müşteri Deneyimi</title>
        <meta name="description" content="Unica müşteri deneyimi platformu ile müşterilerinizin ihtiyaçlarını anlayın, kişiselleştirilmiş deneyimler sunun ve müşteri sadakatini artırın." />
        <meta name="keywords" content="Unica, müşteri deneyimi, NovaGraph, kişiselleştirme, müşteri sadakati, deneyim platformu" />
      </Head>
      {/* Hero Section */}
      <section className="relative py-20 lg:py-32 overflow-hidden bg-blue-800">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Dünyanın önde gelen müşteri deneyimi platformu Unica ile müşterilerinizin ihtiyaçlarını anlayın, 
              kişiselleştirilmiş deneyimler sunun ve müşteri sadakatini artırın.
            </motion.p>
            ...
            >
              <Button 
                ...
                onClick={() => openForm("Unica Müşteri Deneyimi Hizmetleri")}
              >
                İletişime Geç
      ...
      <section className="py-20 bg-blue-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Müşteri deneyimi stratejinizi uzman ekibimizle optimize edin
            </p>
          </motion.div>
            ...
            {[
              {
                icon: Users,
                title: "Uzman Ekip",
                description: "Unica platformunda uzmanlaşmış deneyimli ekibimizle hizmetinizdeyiz"
              },
              {
                icon: Zap,
                title: "Hızlı Entegrasyon",
                description: "Hızlı ve etkili müşteri deneyimi entegrasyonu ile kısa sürede sonuç alın"
              },
              {
                icon: Shield,
                title: "Güvenilir Analiz",
                description: "En güncel ve doğru müşteri verisi analizi ile stratejinizi geliştirin"
              }
            ].map((benefit, index) => (
              <motion.div
                key={index}
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">Müşteri analizi ve segmentasyonu</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-blue-500" />
                    <span className="text-gray-700">Kişiselleştirilmiş deneyim tasarımı</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-blue-500" />
                    <span className="text-gray-700">Müşteri sadakat programları</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-blue-500" />
                    <span className="text-gray-700">Sürekli optimizasyon ve izleme</span>
                  </li>
                </ul>
              </div>
