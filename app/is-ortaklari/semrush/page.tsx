      ...
      <section className="relative py-20 lg:py-32 overflow-hidden bg-orange-800">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-200 to-orange-100">SEMrush</span> ile SEO Performansınızı Artırın
            </motion.h1>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border-0 p-8">
                  <div className="w-20 h-20 bg-orange-500 rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-300 shadow-2xl">
