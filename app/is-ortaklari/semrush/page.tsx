...
export default function SEMrushPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fff3e6]">
      ...
      {/* Hero Section */}
      <section className="relative py-20 lg:py-32 overflow-hidden bg-[#fff3e6]">
        <div className="absolute inset-0 bg-[#fff3e6]/20"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            {/* Back Button */}
            <div className="flex justify-start mb-8">
              <Link href="/is-ortaklari">
                <Button variant="outline" className="flex items-center gap-2 bg-white backdrop-blur-md border-white/20 text-[#b34700] hover:bg-white/30">
            ...
            <motion.div
              ...
              className="inline-flex items-center justify-center space-x-2 bg-white backdrop-blur-md text-[#b34700] px-6 py-3 rounded-full text-sm font-medium mb-8 shadow-lg border border-white/20"
            >
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-7xl font-bold text-[#b34700] mb-6 leading-tight"
            >
            ...
            <motion.p
              ...
              className="text-xl sm:text-2xl text-[#7a4b00] mb-12 max-w-3xl mx-auto leading-relaxed"
            >
            ...
            >
              <Button 
                size="lg" 
                className="bg-white text-orange-800 hover:bg-[#fff3e6] px-8 py-4 rounded-2xl font-semibold shadow-2xl hover:shadow-3xl transition-all duration-300 w-full sm:w-auto text-lg"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-[#7a4b00] max-w-3xl mx-auto">
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border-0 p-8">
                  <div className="w-20 h-20 bg-[#ffe7cc] rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-300 shadow-2xl">
                    <feature.icon className="w-10 h-10 text-[#b34700]" />
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 mb-4">
                    {feature.title}
                  </h3>
                  <p className="text-[#7a4b00]">
                    {feature.description}
                  </p>
                </div>
              </motion.div>
      ...
      <section className="py-20 bg-[#fff3e6]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold text-[#b34700] mb-6">
            ...
            {solutions.map((solution, index) => (
              ...
              >
                <Card className="h-full bg-white backdrop-blur-md rounded-3xl border border-white/20 p-8 hover:bg-white transition-all duration-300">
                  <CardHeader>
                    <CardTitle className="text-2xl font-bold text-[#b34700] mb-4">
                      {solution.title}
                    </CardTitle>
                    <CardDescription className="text-[#7a4b00] text-lg">
                    ...
                    <ul className="space-y-3">
                      {solution.benefits.map((benefit, benefitIndex) => (
                        <li key={benefitIndex} className="flex items-start space-x-3">
                          <CheckCircle className="w-5 h-5 text-[#7a4b00] mt-0.5 flex-shrink-0" />
                          <span className="text-[#7a4b00]">{benefit}</span>
                        </li>
                      ))}
                    </ul>
                    <div className="mt-6 p-4 bg-white backdrop-blur-md rounded-2xl border border-white/20">
                      <p className="text-[#7a4b00] font-medium">
              ...
              >
                <Card className="h-full bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border-0">
                  <CardHeader className="text-center pb-4">
                    <div className="w-16 h-16 mx-auto mb-4 bg-[#ffe7cc] rounded-2xl shadow-xl flex items-center justify-center">
                      <useCase.icon className="w-8 h-8 text-[#b34700]" />
                    </div>
                    <CardTitle className="text-xl font-bold text-gray-900">
                      {useCase.title}
                    </CardTitle>
                    <CardDescription className="text-[#7a4b00]">
                      {useCase.description}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
            ...
            {[
              ...
              >
                <Card className="h-full bg-white backdrop-blur-md rounded-3xl border border-white/20 p-8 hover:bg-white transition-all duration-300">
                  <CardHeader className="text-center pb-4">
                    <div className="w-16 h-16 mx-auto mb-4 bg-[#ffe7cc] rounded-2xl shadow-xl flex items-center justify-center">
                      <benefit.icon className="w-8 h-8 text-[#b34700]" />
                    </div>
                    <CardTitle className="text-xl font-bold text-[#b34700]">
                      {benefit.title}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <CardDescription className="text-[#7a4b00] text-center">
                      {benefit.description}
                    </CardDescription>
                  </CardContent>
                </Card>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-[#fff3e6] rounded-2xl p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  SEO Stratejisi Dönüşümü
                </h3>
                <p className="text-[#7a4b00] mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-[#ff6600]" />
                    <span className="text-[#7a4b00]">SEO analizi ve strateji geliştirme</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-[#ff6600]" />
                    <span className="text-[#7a4b00]">Rakip analizi ve fırsat belirleme</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-[#ff6600]" />
                    <span className="text-[#7a4b00]">Anahtar kelime araştırması ve optimizasyonu</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-[#ff6600]" />
                    <span className="text-[#7a4b00]">Sürekli performans izleme ve raporlama</span>
                  </li>
                </ul>
              </div>
              <div className="text-center">
                <div className="w-32 h-32 mx-auto mb-4 bg-[#ffe7cc] rounded-full shadow-2xl flex items-center justify-center">
                  <Search className="w-16 h-16 text-[#b34700]" />
                </div>
                <p className="text-[#7a4b00]">
                  SEO stratejinizi NovaGraph'in uzmanlığı ile optimize edin
                </p>
