        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <Link href="/is-ortaklari">
              <Button variant="outline" className="bg-white/20 backdrop-blur-md border-white/30 text-white hover:bg-white/30">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <motion.div
              ...
              className="mb-8"
            >
              <Badge className="px-6 py-3 bg-white/20 backdrop-blur-md border-white/30 text-white shadow-lg">
                İş Ortağımız
              </Badge>
            </motion.div>
