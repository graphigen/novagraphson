...
export default function StripePage() {
  ...
  const features = [
    {
      ...
      description: "Güvenli ve hızlı ödeme işleme"
    },
    {
      icon: Shield,
      title: "Güvenlik",
    ...
    },
    {
      ...
      description: "Uluslararası ödeme çözümleri"
    },
    {
      icon: Users,
      title: "Subscription Billing",
      description: "Abonelik ve tekrarlayan ödemeler"
    }
  ]
  ...
  const solutions = [
    ...
    {
      title: "Subscription Billing",
      description: "Abonelik ve tekrarlayan ödeme çözümleri",
      benefits: [
        "Abonelik yönetimi",
        "Otomatik ödeme",
      ...
      novaGraphUsage: "Müşteri abonelik sistemleri kurma ve yönetimi"
    },
    {
      title: "International Payments",
      description: "Uluslararası ödeme çözümleri",
      ...
      novaGraphUsage: "Müşteri uluslararası ödeme sistemleri kurma"
    }
  ]
  ...
  const useCases = [
    ...
    },
    {
      ...
      description: "SaaS şirketleri için abonelik ödeme çözümleri",
      icon: Users,
      benefits: [
        "Abonelik yönetimi",
        "Otomatik ödeme",
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex justify-start mb-8">
              <Link href="/is-ortaklari">
                <Button variant="outline" className="flex items-center gap-2 bg-white backdrop-blur-md border-white/20 text-[#0069f9] hover:bg-white/30">
            ...
            <motion.div
              ...
              className="inline-flex items-center justify-center space-x-2 bg-white backdrop-blur-md text-[#0069f9] px-6 py-3 rounded-full text-sm font-medium mb-8 shadow-lg border border-white/20"
            >
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-7xl font-bold text-[#0069f9] mb-6 leading-tight"
            >
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-200 to-purple-100">Stripe</span> ile Ödeme Süreçlerinizi Güçlendirin
            </motion.h1>
            ...
            >
              Dünyanın en güçlü ödeme platformu Stripe ile müşterilerinize güvenli ödeme deneyimi sunun, 
            ...
            >
              <Button 
                ...
                onClick={() => openForm("Stripe Ödeme Hizmetleri")}
              >
                İletişime Geç
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Stripe ile Neler Yapabilirsiniz?
            </h2>
            <p className="text-xl text-[#154ea2] max-w-3xl mx-auto">
              Ödeme süreçlerinizi güçlendirmek için ihtiyacınız olan tüm araçlar Stripe'da.
            </p>
          </motion.div>
              ...
              >
                <div className="bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border-0 p-8">
                  <div className="w-20 h-20 bg-purple-500 rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-300 shadow-2xl">
                    <feature.icon className="w-10 h-10 text-[#0069f9]" />
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 mb-4">
                    {feature.title}
                  </h3>
                  <p className="text-[#154ea2]">
                    {feature.description}
                  </p>
                </div>
              </motion.div>
      ...
      <section className="py-20 bg-purple-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold text-[#0069f9] mb-6">
              NovaGraph ile Stripe Çözümleri
            </h2>
            ...
            {solutions.map((solution, index) => (
              ...
              >
                <Card className="h-full bg-white backdrop-blur-md rounded-3xl border border-white/20 p-8 hover:bg-white transition-all duration-300">
                  <CardHeader>
                    <CardTitle className="text-2xl font-bold text-[#0069f9] mb-4">
                      {solution.title}
                    </CardTitle>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-[#154ea2] max-w-3xl mx-auto">
              Stripe ile farklı iş modelleriniz için ödeme çözümleri
            </p>
          </motion.div>
                ...
                <Card className="h-full bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border-0">
                  <CardHeader className="text-center pb-4">
                    <div className="w-16 h-16 mx-auto mb-4 bg-purple-500 rounded-2xl shadow-xl flex items-center justify-center">
                      <useCase.icon className="w-8 h-8 text-[#0069f9]" />
                    </div>
                    <CardTitle className="text-xl font-bold text-gray-900">
                      {useCase.title}
                    </CardTitle>
                    <CardDescription className="text-[#154ea2]">
                      {useCase.description}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-3">
                      {useCase.benefits.map((benefit, benefitIndex) => (
                        <li key={benefitIndex} className="flex items-start space-x-3">
                          ...
                          <span className="text-[#154ea2]">{benefit}</span>
                        </li>
                      ))}
                    </ul>
                  </CardContent>
            ...
            {[
              {
                icon: Users,
                title: "Uzman Ekip",
                description: "Stripe platformunda uzmanlaşmış deneyimli ekibimizle hizmetinizdeyiz"
              },
              {
                icon: Zap,
                ...
                <Card className="h-full bg-white backdrop-blur-md rounded-3xl border border-white/20 p-8 hover:bg-white transition-all duration-300">
                  <CardHeader className="text-center pb-4">
                    <div className="w-16 h-16 mx-auto mb-4 bg-purple-400 rounded-2xl shadow-xl flex items-center justify-center">
                      <benefit.icon className="w-8 h-8 text-[#0069f9]" />
                    </div>
                    <CardTitle className="text-xl font-bold text-[#0069f9]">
                      {benefit.title}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
          ...
          <div className="bg-purple-50 rounded-2xl p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-[#154ea2] mb-6">
                  NovaGraph olarak Stripe platformunu kullanarak müşterilerinizin ödeme süreçlerini 
                ...
                <ul className="space-y-3">
                  <li className="flex items-center space-x-3">
                    ...
                    <span className="text-[#154ea2]">Ödeme sistemi kurulumu ve entegrasyonu</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-purple-500" />
                    <span className="text-[#154ea2]">Güvenlik ve uyumluluk çözümleri</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-purple-500" />
                    <span className="text-[#154ea2]">Müşteri deneyimi optimizasyonu</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-purple-500" />
                    <span className="text-[#154ea2]">Sürekli destek ve izleme</span>
                  </li>
                </ul>
              </div>
              <div className="text-center">
                <div className="w-32 h-32 mx-auto mb-4 bg-purple-500 rounded-full shadow-2xl flex items-center justify-center">
                  <CreditCard className="w-16 h-16 text-[#0069f9]" />
                </div>
                <p className="text-[#154ea2]">
                  Ödeme süreçlerinizi NovaGraph'in uzmanlığı ile optimize edin
                </p>
