...
const MegaMenu = ({ isOpen, onClose, activeSolutionGroup, setActiveSolutionGroup }: MegaMenuProps) => {
  ...
  const solutionGroups: SolutionGroup[] = [
    ...
    },
    {
      ...
      services: [
        { name: "5651 Loglama", icon: Monitor, href: "#logging" },
        { name: "VPN", icon: Shield, href: "#vpn" },
        { name: "Hotspot", icon: Wifi, href: "#hotspot" },
        { name: "Web Filtreleme", icon: Filter, href: "#filtering" },
        { name: "ZTNA Firewall", icon: Lock, href: "#ztna-firewall" },
        { name: "Cihaz Kontrolü", icon: Activity, href: "#device-monitoring" },
        { name: "Verimlilik Takibi", icon: BarChart3, href: "#productivity" },
      ],
    },
  ]
