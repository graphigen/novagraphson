  ...
  return (
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors inline-flex items-center">
                  NovaGraph Mobil Uygulama
                  <span className="ml-2 bg-yellow-400 text-black text-xs px-2 py-1 rounded font-medium">YENİ</span>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Open Graph Ön İzleme
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Meta Title ve Description Önizleme
                </a>
              </li>
            </ul>
          </div>
        ...
        {/* Partner Logos */}
        <div className="flex flex-wrap items-center justify-center lg:justify-start space-x-8 mb-8 opacity-60">
          <div className="text-sm text-gray-500">Ana Sponsor</div>
          <div className="text-sm text-gray-500">Resmi Eşleştiricisi</div>
          <div className="text-sm text-gray-500">Göztepe Basketbol</div>
          <div className="text-sm text-gray-500">Sivasspor A.C.E Awards</div>
          <div className="bg-green-100 text-green-800 px-2 py-1 rounded text-xs font-medium">50 Technology Fast 50</div>
        </div>

        {/* Bottom Footer */}
        <div className="flex flex-col lg:flex-row justify-between items-center pt-8 border-t border-gray-200">
          <div className="text-sm text-gray-500 mb-4 lg:mb-0">©2025 NovaGraph Teknoloji A.Ş. Tüm hakları saklıdır.</div>
