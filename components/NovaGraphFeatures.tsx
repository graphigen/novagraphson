          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl p-8 shadow-xl">
              <div className="flex items-center justify-between mb-8">
                <div>
                  <div className="text-sm text-gray-500 mb-2">Dijital Pazarlamadan Gelen Ciro</div>
                  <div className="text-4xl font-bold text-gray-900">
                    {chartValue >= 1000000 ? `${(chartValue / 1000000).toFixed(1)} Milyon ₺` : `${(chartValue / 1000).toFixed(0)} Bin ₺`}
                  </div>
                  <div className="flex items-center mt-2">
                    <TrendingUp className="w-4 h-4 text-green-500 mr-1" />
                    <span className="text-sm text-green-600 font-medium">+268% 6 aylık</span>
                  </div>
                </div>
              ...
              <div className="relative h-80 mb-6" ref={chartRef}>
                {/* Chart Background */}
                ...
                <div className="absolute top-4 right-4 bg-green-50 border border-green-200 rounded-lg px-4 py-2 shadow-lg z-20">
                  <div className="text-xs text-green-600 font-medium">Hedef Aşıldı</div>
                  <div className="text-lg font-bold text-green-700">+{targetValue.toFixed(0)}%</div>
                </div>

                <div className="absolute bottom-4 left-4 bg-blue-50 border border-blue-200 rounded-lg px-4 py-2 shadow-lg z-20">
                  <div className="text-xs text-blue-600 font-medium">Trend Analizi</div>
                  <div className="text-sm font-bold text-blue-700">Güçlü Yükseliş</div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between border-t pt-4">
                <div className="flex items-center space-x-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-600">Dijital Pazarlama Geliri</span>
                  </div>
                  <div className="flex items-center space-x-2">
                ...
                <div className="text-sm text-gray-500">Son 6 Ay Performansı</div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <span className="text-sm font-medium text-white">E-Posta Kampanyaları</span>
                </div>
                <div>
                  <div className="text-sm text-blue-200 mb-1">Toplam Gönderim</div>
                  <div className="text-3xl font-bold text-white">{emailCount.toLocaleString('tr-TR')}</div>
                  <div className="text-xs text-green-400 mt-1">+18% bu ay</div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <span className="text-sm font-medium text-white">WhatsApp Pazarlama</span>
                </div>
                <div>
                  <div className="text-sm text-blue-200 mb-1">Toplam Mesaj</div>
                  <div className="text-3xl font-bold text-white">{whatsappCount.toLocaleString('tr-TR')}</div>
                  <div className="text-xs text-green-400 mt-1">+32% bu ay</div>
                </div>
              </div>

              {/* Performance Metrics */}
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                <div className="text-sm font-medium mb-4 text-white">Kampanya Performansı</div>
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <div className="text-xl font-bold text-white">24x</div>
                  </div>
                  <div>
                    <div className="flex items-center space-x-2 mb-1">
                      <Monitor className="w-4 h-4 text-blue-400" />
                      <span className="text-xs text-blue-200">Maliyet</span>
                    </div>
                    <div className="text-xl font-bold text-white">80.000 ₺</div>
                  </div>
                </div>

                <div className="pt-4 border-t border-white/20">
                  <div className="flex items-center space-x-2 mb-1">
                    <span className="text-sm text-blue-200">Net Kazanç</span>
                    <div className="w-4 h-4 bg-green-500 rounded-full flex items-center justify-center">
                      <span className="text-xs text-white">₺</span>
                    </div>
                  </div>
                  <div className="text-2xl font-bold text-white">{netProfit.toLocaleString('tr-TR')} ₺</div>
                </div>
              </div>
            </div>
          </div>
